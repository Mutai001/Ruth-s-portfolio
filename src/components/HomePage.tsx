      ...
      <div className="max-w-4xl w-full bg-black/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-2xl">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full opacity-75 group-hover:opacity-100 blur transition duration-500"></div>
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              <button 
                className="px-6 py-3 bg-purple-500 hover:bg-purple-400 text-white font-bold rounded-lg transition-all duration-300 transform hover:-translate-y-1 shadow-lg"
        ...
        <div className="mt-12 flex flex-wrap justify-center md:justify-start gap-3">
          <span className="px-3 py-1 bg-black/30 text-white rounded-full text-sm">Content Strategy</span>
          <span className="px-3 py-1 bg-black/30 text-white rounded-full text-sm">Community Management</span>
          <span className="px-3 py-1 bg-black/30 text-white rounded-full text-sm">Analytics</span>
          <span className="px-3 py-1 bg-black/30 text-white rounded-full text-sm">Paid Campaigns</span>
          <span className="px-3 py-1 bg-black/30 text-white rounded-full text-sm">Brand Development</span>
        </div>
